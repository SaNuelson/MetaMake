import { recognizeTimestamps } from '../recognize.js';
...
describe('recognizeTimestamps', () => {
    ...
    it('should correctly recognize a format of dates with missing values', () => {
        const timeStamps = ['2015-11-01', '2015-10-13', '2005-08-17', '2000-10-17', '2006-04-27', '2013-05-21', '2019-07-31', '', '2019-10-23', '2021-06-24', '2021-07-16', '2019-07-26'];
