...
export function Table({hasHeader, children}: TableProps): React.JSX.Element {
...
export function KnowledgeBaseTableRow({knowledge_base_name, format, date_created, other} : KnowledgeBaseTableRowProps): React.JSX.Element {
  return (
    <tr className="border-b transition duration-300 ease-in-out hover:bg-neutral-100 dark:border-neutral-500 dark:hover:bg-neutral-600">
      <td className="whitespace-nowrap px-6 py-4 font-medium">{knowledge_base_name}</td>
      <td className="whitespace-nowrap px-6 py-4">{format}</td>
      <td className="whitespace-nowrap px-6 py-4">{date_created}</td>
