...
const IntelPropertyCodebook: CodebookEntry[] = [
  {
    ...
    label: 'Distribuce datové sady obsahuje více autorských děl'
  },
  {
    uri: 'https://creativecommons.org/licenses/by/4.0/',
    label: 'Licence CC BY 4.0 DEED'
  },
  {
...
const DatabaseOriginalityCodebook: CodebookEntry[] = [
  {
    uri: 'https://creativecommons.org/licenses/by/4.0/',
    label: 'Licencované CC BY 4.0 DEED'
  },
  {
...
const PersonalDataPresenceCodebook: CodebookEntry[] = [
  {
    ...
    label: 'Distribuce datové sady obsahuje osobní údaje'
  },
  {
    ...
    // 3.4.1 Specifikace podmínek užití
    {
      ...
      property: new StructuredMetaProperty(
        ...
        [
          ...
          {
            arity: MandatoryArity,
            property: new MetaProperty('Autor díla', 'Autor díla.', 'string')
          },
          {
            arity: MandatoryArity,
            property: new EnumMetaProperty(
          ...
          {
            arity: MandatoryArity,
            property: new MetaProperty('Autor databáze', 'Autor databáze.', 'string')
          },
          {
            arity: MandatoryArity,
            property: new EnumMetaProperty(
